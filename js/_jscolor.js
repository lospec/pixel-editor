...
//returns rgb color object [lospec]
this.toRgb = function () {
    return {
...
//this is called when the picker is closed
...
function drawPicker () {
    ...
    // wrap
    p.wrap.classList.add('jscolor-wrap');
    ...
    // picker
    p.box.classList.add('jscolor-box');
    p.box.style.width = dims[0] + 'px';
    p.box.style.height = (dims[1]+25) + 'px'; //added 25 for trash icon
    ...
    // picker border
    p.wrap.classList.add('jscolor-boxB');
    ...
    // pad
    p.pad.classList.add('jscolor-pad');
    ...
    // pad border
    p.padB.classList.add('jscolor-padB');
    ...
    // pad mouse area
    p.padM.classList.add('jscolor-padM');
    ...
    // pad cross
    p.cross.classList.add('jscolor-cross');
    ...
    // slider
    p.sld.classList.add('jscolor-sld');
    ...
    /* REMOVED CLOSE BUTTON [lospec]
    // the Close button
    p.btn.classList.add('jscolor-btn');
    ...
    */
    ...
    //CUSTOM PICKER BOTTOM - [lospec]
    //when first initialized, we will want to move the colorPickerBottom 
    //to the bottom of the color picker box
    if (colorPickerBottomAdded != true) {
        //get color picker bottom
        var jsColorPickerBottom = document.getElementsByClassName('jscolor-picker-bottom')[0];

        //move it to the picker box
        p.box.appendChild(jsColorPickerBottom);

        //unhide element
        jsColorPickerBottom.style.display = 'block';

        //set flag to only do this once
        colorPickerBottomAdded = true;
